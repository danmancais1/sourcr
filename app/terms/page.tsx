    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto max-w-2xl px-4 py-12">
        ...
        <div className="prose prose-neutral mt-8 dark:prose-invert">
          ...
          <h2 className="mt-6 text-xl font-semibold">1. Use of the platform</h2>
          <p>
          ...
          <h2 className="mt-6 text-xl font-semibold">2. Subscription and payment</h2>
          <p>
            Paid plans are billed via Stripe. You may cancel at any time. Refunds are at our discretion.
          </p>
          <h2 className="mt-6 text-xl font-semibold">3. Limitation of liability</h2>
          <p>
          ...
          <h2 className="mt-6 text-xl font-semibold">4. Changes</h2>
          <p>
