...
import { createSellerWorkspaceAndCheckout } from "./actions";
...
const PLANS = [
  {
    ...
    price: "£29",
    period: "/month",
    description: "For landlords and sellers.",
    features: ["Upload properties", "Post opportunity ads", "See investor directory", "Messaging"],
  },
  {
    id: "pro" as const,
    name: "Pro",
    ...
    features: ["Everything in Starter", "Priority matching", "More listings", "Priority support"],
    highlighted: true,
  },
];

export function SellerOnboardingForm({ defaultPlan = "starter" }: { defaultPlan?: "starter" | "pro" }) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      formData.set("name", name.trim() || "My account");
      await createSellerWorkspaceAndCheckout(formData);
    } catch (e) {
  ...
  return (
    <Card className="border-deep-teal-700">
      <CardHeader>
        <CardTitle className="text-deep-teal-50">Subscribe to get started</CardTitle>
        <CardDescription className="text-deep-teal-200">
          Choose a plan and account name. You&apos;ll be taken to Stripe to enter your payment details.
        </CardDescription>
      </CardHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="e.g. My Seller Account"
              required
